...
orig_save_data_path = str(paths.data / "Fig3_Storage") + "/"
...
for model in models:
    ...
    # weighting on the physical-parameter distribution can be visualised later (Figure 4b).
    ...
    # ── Figure 4a: NLLD corner scatter coloured by cluster ─────────────────
    print('    FIGURE 4 - NLLD corner scatter')
    n_cl = len(unique_cl)
    ...
    # ── Figure 4b: Physical parameter corner scatter coloured by cluster ──────
    print('    FIGURE 4b - Physical parameters corner scatter coloured by NLLD cluster')
