...
# This file retrieves the chi-squared spaces for pairs of parameters and uses it to Appendix 4, which plots a corner plot of correlations.
...
def load_base_data(seed):
    ...
    Fig2_plot.py/Fig4_run.py/Fig4_plot.py, since they all compute the exact same
...
fig.tight_layout()
plt.savefig(paths.figures / "Appendix4.pdf", bbox_inches="tight")
plt.close(fig)
