...
\autoref{fig:appendix_fig2} shows the full distribution of fourth-order non-linear LDCs across $T_{\rm eff}$ and wavelength, while \autoref{fig:appendix_fig3} shows the same LDC space partitioned by hierarchical cluster membership.
