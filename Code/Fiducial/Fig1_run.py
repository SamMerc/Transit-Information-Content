...
# 0.5. Plotting the log probability
...
# 1. Plot the trace of each parameter's chains
print('STEP 1: TRACE')
_ = az.plot_trace(
    inf_data,
...
# 2. Plot the cornerplot of the chains
print('STEP 2: CORNER')
...
# 3. Plot the best-fit and median models against the data
print('STEP 3: BESTFIT LC')
...
# 4. Compute the amplification factor between the retrieved transit depth error and the expected error
print('STEP 4: AMP FACTOR')       
