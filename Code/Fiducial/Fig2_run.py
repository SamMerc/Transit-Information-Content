...
# In order to showcase the impact of every parameter, we include some eccentricity and argument of periastron to this dataset.
# In this file the MCMC is setup and run.
...
fixed_args['labels'] = ["RpR$_*$", 'i', "aR$_*$", "u$_1$", "u$_2$", "u$_3$", "P", "$\sqrt{e}\cos{\omega}$", "$\sqrt{e}\sin{\omega}$"]
