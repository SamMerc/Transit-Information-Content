...
# In particular the grid is 0.6-5.3 micron with R=300 wavelengths by 5 impact parameters by 10 stellar effective temperatures by 10 noise seeds, i.e. 350 injection-retrievals.
